...
public class AdminQuestionController {
  ...
  @PostMapping
  public void save(@PathVariable Long id, @RequestBody QuestionDto questionDto, HttpServletResponse response) {
  ...
  @PutMapping
  public void update(@PathVariable Long id, @RequestBody QuestionDto questionDto, HttpServletResponse response) {
    Question question = questionDto.toQuestion();
    question.setVacancy(vacancyService.findById(id));
